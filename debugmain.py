...
client = commands.Bot(command_prefix='.', help_command = commands.MinimalHelpCommand()) # HelpCommand()
...
client.run('OTgxMjIyMzk5MzUxNTkwOTIy.GPkK64.wL12CnrqqavwcCWHtbskxIEWGjuZ9LWN7YhWfw')
